...
# ==========================================
# Main Execution Block (Windows fix)
# ==========================================
if __name__ == '__main__':
    # freeze_support() # Windowsで実行ファイル化する場合に必要ですが、通常スクリプト実行ならなくても動きます
    ...
    df = pd.DataFrame(predictions, columns=['image_id', 'label'])
    submit_path = os.path.join(Config.output_dir, 'Prediction', 'submission_ensemble_final_b4.csv')
